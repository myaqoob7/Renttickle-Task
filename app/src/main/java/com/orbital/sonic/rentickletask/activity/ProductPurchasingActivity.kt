package com.orbital.sonic.rentickletask.activity
...
class ProductPurchasingActivity : AppCompatActivity() {
    ...
    private fun settingData(){
        ...
        productCountingRatingReviews.text="${trendingProductItem.productCountingRating} Rating | ${trendingProductItem.productCountingReviews} Revies"
